    ...
    <div className="bg-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100 p-6 max-w-md mx-auto space-y-5">
      ...
      <div className="flex justify-between">
       ...
       <div className="flex justify-between">
        ...
        {/* <span className="text-gray-900">{projectData.startingDate}</span> */}
                <span className="text-gray-900">2025-12-31</span>
      ...
      <div className="flex justify-between items-center">
        ...
        <span
          className={`inline-flex items-center gap-2 px-3 py-1 rounded-md text-sm font-medium border ${projectData.status?.toLowerCase() === "open"
            ...
            <>
              {projectData.members.slice(0, 3).map((member, i) => (
                <img
                  ...
                  className={`w-8 h-8 rounded-full border-2 border-gray-200 ${i !== 0 ? "-ml-3" : ""
                    }`}
                />
              ))}
