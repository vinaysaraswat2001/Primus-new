...
const ProjectCalendar = () => {
  ...
  return (
<div className="space-y-4 bg-[#F5F5F5] rounded-md p-3 h-[500px]">
      ...
      <div className="bg-white border border-gray-300 rounded-md p-4 h-[21rem]">
        ...
        <div className="grid grid-cols-7 gap-[1.6rem] text-xs text-[#1f1f1f]">
