...
const API = "http://127.0.0.1:8000/primus/in-news";
...
const filtered = useMemo(() => {
    ...
    return (
        <>
            <section>
                <div className="p-6 bg-white mt-[1rem] rounded-3xl  min-h-[59vh] max-h-[120vh] overflow-y-auto custom-scrollbar ">
...
export default AdvisoryNewsUpdates;