    ...
    <div className="flex flex-col z-[99999]">
      ...
      <nav className="text-black px-3 py-3 flex items-center justify-between z-[20]">
        ...
        <div className="hidden md:flex gap-8 text-[13px] font-medium bg-white rounded-full px-6 py-2 shadow-md">
          <NavLink to="vendor-dashboard" className={linkClasses} end>Dashboard</NavLink>
          <NavLink to="vendor-invoice" className={linkClasses}>Invoice</NavLink>
          <NavLink to="vendor-meeting-schedule" className={linkClasses}>Meetings</NavLink>
          <NavLink to="vendor-reach-out" className={linkClasses}>Reach Out</NavLink>
          <NavLink to="vendor-share-feedback" className={linkClasses}>Share Feedback</NavLink>
          <NavLink to="vendor-publications" className={linkClasses}>Publications</NavLink>
        </div>
      ...
      {menuOpen && !isEditProfile && (
        <div className="md:hidden bg-white text-black flex flex-col items-center space-y-4 py-4 shadow-md z-[99999]">
          ...
          <NavLink to="vendor-invoice" className={linkClasses}>Invoice</NavLink>
          <NavLink to="vendor-meeting-schedule" className={linkClasses} onClick={() => setMenuOpen(false)}>Meetings</NavLink>
          <NavLink to="vendor-reach-out" className={linkClasses} onClick={() => setMenuOpen(false)}>Reach Out</NavLink>
          <NavLink to="vendor-share-feedback" className={linkClasses} onClick={() => setMenuOpen(false)}>Share Feedback</NavLink>
          <NavLink to="vendor-publications" className={linkClasses} onClick={() => setMenuOpen(false)}>Publications</NavLink>
        </div>
      )}
